...
public class Faction {
    ...
    public void fromSaveString(String encodedString, CampaignDatabase database) {
        ...
        TargetDatabase<Card> cDatabase = database.getCards();
        TargetDatabase<Location> lDatabase = database.getLocations();
        name = stringCats[0];
    ...
    public boolean ownsThing(BaseObject t) {
    ...
    public <T extends BaseObject> void addThing(T thing) {
    ...
    public void removeThing(BaseObject baseObject) {
        if (baseObject instanceof Card) {
            ownedAgents.remove((Card) baseObject);
            unownedAgents.add((Card) baseObject);
        }
        else if(baseObject instanceof Location)
        {
            ownedLocations.remove((Location) baseObject);
            unownedLocations.add((Location) baseObject);
        }
    }
